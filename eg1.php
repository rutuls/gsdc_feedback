...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]."?engid=".$_GET['engid']);?>"> 
  ...
  <font size="4" color="black"><b>  1. The work was delivered on time, as promised to my customer:</b></font><br>
   ...
   <input type="radio" name="a3" <?php if (isset($a3) && $a3=="neither agree or disagree") echo "checked";?>  value="neither agree or disagree">Neighter Agree nor Disagree<br>
  ...
  <font size="4" color="black"><b> 3. The GSDC engineer(s) had the requisite technical knowledge for this project:</b></font><br>
   ...
   <input type="radio" name="a4" <?php if (isset($a4) && $a4=="neither agree or disagree") echo "checked";?>  value="neither agree or disagree">Neighter Agree nor Disagree<br>
  ...
  <font size="4" color="black"><b> 4. The GSDC engineer(s) was able to handle the customer's technical queries:</b></font><br>
   ...
   <input type="radio" name="a5" <?php if (isset($a5) && $a5=="neither agree or disagree") echo "checked";?>  value="neither agree or disagree">Neighter Agree nor Disagree<br>
   ...
   <input type="radio" name="a6" <?php if (isset($a6) && $a6=="neither agree or disagree") echo "checked";?>  value="neither agree or disagree">Neighter Agree nor Disagree<br>
  ...
  <font size="4" color="black"><b> 6. I found it easy to engage the GSDC for this project:</b></font><br>
   ...
   <input type="radio" name="a7" <?php if (isset($a7) && $a7=="neither agree or disagree") echo "checked";?>  value="neither agree or disagree">Neighter Agree nor Disagree<br>
...
<font size="4" color="black"><b>7. I'm satisfied with the GSDC's speed in responding to my request:</b></font><br>
   ...
   <input type="radio" name="a8" <?php if (isset($a8) && $a8=="neither agree or disagree") echo "checked";?>  value="neither agree or disagree">Neighter Agree nor Disagree<br>
